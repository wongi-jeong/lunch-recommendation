...
> 🇰🇷 한국어版: [README.md](README.md) · チームプロジェクト（開発2・デザイン2・企画/リサーチ共同、役割は下記 [コントリビューション](#コントリビューションチームプロジェクト)参照）
...
<!-- リサーチ成果物の画像を docs/ に保存し、下のコメントを解除してください:
...
> リサーチ成果物（IA・ペルソナ・アンケート・ニーズ優先順位）は上表のように `docs/` へ画像として追加できます。
...
<!-- スクリーンショットを docs/ に保存し、下のコメントを解除してください。
...
## コントリビューション（チームプロジェクト）

**開発 (2名)**
- **정원기 / Wongi Jeong ([@wongi-jeong](https://github.com/wongi-jeong))** — バックエンド推薦ロジックと **Google Places 連携**、飲食店/会員/投票ドメイン・DB 設計、フロントエンドの大部分（認証・ルーレット・投票・お気に入り・地図・フィルター UI）を主導
- **Heesun Hong ([@h3136514](https://github.com/h3136514))** — プロジェクト初期セットアップ（フロント/バック）、リポジトリ管理

**デザイン (2名, Figma)**
- **김주희 (Kim Juhui), 장유진 (Jang Yujin)** — デザインシステム・画面・コンポーネント設計（Figma Dev Mode MCP でフロントへ反映）

**企画・リサーチ** — チーム共同（課題定義・競合調査・ユーザーアンケート・ペルソナ）

> 開発コントリビューションはコミット履歴（`git shortlog -sne`、ブランチ別の変更履歴）で確認できます。
