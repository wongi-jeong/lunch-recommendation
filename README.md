...
> 🇯🇵 日本語版: [README.ja.md](README.ja.md) · 팀 프로젝트 (개발 2 · 디자인 2 · 기획/리서치 공동, 역할은 아래 [팀](#팀-team) 참고)
...
| 이름 | 구분 | 담당 |
|---|---|---|
| **정원기** ([@wongi-jeong](https://github.com/wongi-jeong)) | 개발 (주도) | 백엔드 추천 로직·**Google Places 연동**, 식당/회원/투표 도메인·DB 설계, 프론트엔드 대부분(인증·룰렛·투표·즐겨찾기·지도·필터 UI) |
| **Heesun Hong** ([@h3136514](https://github.com/h3136514)) | 개발 | 초기 프로젝트 셋팅(프론트/백엔드), 저장소 관리 |
| **김주희** | 디자인 | Figma 디자인 시스템·화면·컴포넌트 설계 |
| **장유진** | 디자인 | Figma 디자인 시스템·화면·컴포넌트 설계 |

> **기획·리서치**(문제 정의·경쟁사 조사·사용자 설문·페르소나)는 팀 공동 진행. 개발 기여는 커밋 이력(`git shortlog -sne`, 브랜치별 변경 이력)에서 확인할 수 있습니다.
